...
export const FAQ = () => {
  return (
    <div>
         <Box ml="11%" mr="15%">
         <Box> 
         <Heading size="md" mb="30px" textAlign="start">Frequently Asked Questions</Heading>
         <Accordion allowToggle>  
         {/* 1 Module */}
         <Box mb="15px">
            <AccordionItem w="75%" border="0" boxShadow="md" borderRadius="10px">
            <AccordionButton _hover={{ borderColor: 'transparent', boxShadow: 'none', backgroundColor: '#f5f5f5' }}
                  ...
                  _focusVisible={{ boxShadow: 'none', borderColor: 'transparent', backgroundColor: 'transparent' }} color="black">
