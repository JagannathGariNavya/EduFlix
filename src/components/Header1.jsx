                ...
                <Box ml="10%" color="white" w="47.4%" mt="10px" mb="30px">
                    ...
                    <Card maxW='sm'>
                        <CardBody>
                            ...
                            <Box m="auto">
                            <Button size="lg" mt="15px" mr="20px" colorScheme='teal' variant='outline'  onClick={() => addToCart(false)}>
                             Add to cart <Badge color="white"  paddingLeft="3px" paddingRight="3px" bg="#056a67" ml="4px" mb="20px">{cartCount}</Badge>
                            </Button>
                                <Button size="lg" bg="#056a67" colorScheme='teal' mt="15px" onClick={handleBuyNow}>Go to cart</Button>
